...
<form action="infotable_tjbmsh?infono=${infotable.infono}" method="post">
	<input type="button" id="s1" value="通 过"onclick="div1()">
	<input type="text" value="" id="jg" name ="jg" style="display:none">
	<input id="s2" type="button"  value="不通过" onclick="div2()">
	<div id="btg" style="display:none">
	不通过原因（选填）
   <textarea style="overflow-y:scroll"  rows="8" cols="40" style="resize:none;" name="bmshyj"></textarea> <br>
	</div>
