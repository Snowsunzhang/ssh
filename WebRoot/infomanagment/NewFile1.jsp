                                ...
                                <div class="bs_navleft">
                                    <li>
                                        ...
                                        <script>
                                            ...
                                            var day = now.getDate();
                                            var currentime = year + "年" + month + "月" + day + "日 " + weekDayLabels[now.getDay()]  ;                                          document.write(currentime);
                                        </script>
                                    </li>
                                    <div class="clear">
                                    </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%" height="100%" frameBorder=0 id=frmright name=frmright src="addinfo.jsp?name=${usermame}" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
